...
public class JpegEncoder extends Frame {
    ...
    /**
     * Initialize an encoding setting.
     *
     * @param image   a java.awt.Image object representing the input image
     * @param quality Quality of the image
     *                0 to 100 and from bad image quality, high compression to good.
     * @param out     an OutputStream object of the file storing produced JPEG image.
     */
    ...
    /**
     * Produce the JPEG compressed image.
     */
...
//                        }
    ...
    /**
     * Append EOI (End of Image) marker to the output stream.
     * @param out
     */
    ...
    /**
     * Write JPEG marker data to the given output stream.
     * @param data  JPEG marker data
